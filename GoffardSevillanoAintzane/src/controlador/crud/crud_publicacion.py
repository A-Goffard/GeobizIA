...
class CrudPublicacion(BaseCRUD):
    def __init__(self):
        super().__init__(
            ...
            fields=[
                "id_publicacion", "titulo", "contenido", "autor", "fecha_creacion", "estado",
                "tags", "palabras_clave", "generada_por_ia", "id_generador_ia", "feedback_empresa",
                "id_tipo_publicacion", "id_plantilla"
            ],
