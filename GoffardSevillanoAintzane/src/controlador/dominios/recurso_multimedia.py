class RecursoMultimedia:
    ...
    @staticmethod
    def crear_recurso_multimedia(id_recurso_multimedia, tipo, titulo, fecha_subida, autor):
        return RecursoMultimedia(id_recurso_multimedia, tipo, titulo, fecha_subida, autor)

    @property
    def id_recurso_multimedia(self): return self._id_recurso_multimedia
    @id_recurso_multimedia.setter
    def id_recurso_multimedia(self, id_recurso_multimedia): self._id_recurso_multimedia = id_recurso_multimedia
    ...
    @property
    def fecha_subida(self): return self._fecha_subida
    @fecha_subida.setter
    def fecha_subida(self, fecha_subida): self._fecha_subida = fecha_subida

    @property
    def autor(self): return self._autor
    @autor.setter
    def autor(self, autor): self._autor = autor

    def __str__(self):
        return (
            f"ID: {self.id_recurso_multimedia}, Tipo: {self.tipo}, Título: {self.titulo}, "
            f"Fecha subida: {self.fecha_subida}, Autor: {self.autor}"
        )
